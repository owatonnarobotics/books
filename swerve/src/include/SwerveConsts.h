...
const int R_CANIDZionFrontRightSwerve = 12;
const int R_CANIDZionFrontRightDrive  = 10;
const int R_CANIDZionFrontLeftSwerve  = 3;
const int R_CANIDZionFrontLeftDrive   = 1;
const int R_CANIDZionRearLeftSwerve   = 9;
const int R_CANIDZionRearLeftDrive    = 7;
const int R_CANIDZionRearRightSwerve  = 6;
const int R_CANIDZionRearRightDrive   = 4;

const int R_CANIDZionFrontRightEncoder = 11;
const int R_CANIDZionFrontLeftEncoder = 2;
const int R_CANIDZionRearLeftEncoder = 8;
const int R_CANIDZionRearRightEncoder = 5;
